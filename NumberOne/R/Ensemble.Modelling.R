...
#'  plot (receiving operative curve) and the upper left coin
#'  (1,1).}\item{metric}{Choice of the metric used to compute binary map
#'  threshold and confusion matrix : \strong{Kappa} maximizes the model Kappa
#'  value, \strong{CCR} maximizes the correct predicted observations proportion,
...
#'  the upper left coin (1,1).} \item{axes.metric}{Choice of the metric used
#'  to evaluate the variables relative importance in percent (variation of the
...
#'  \strong{sensitivity}, \strong{specificity}, and \strong{prop.correct}correct
#'  predicted occurences proportion.} \item{"..."}{See algorithm in detail
#'  section} }
#'
