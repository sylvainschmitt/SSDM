.checkargs = function(Xcol = 'Longitude',
                      ...
                      stack = Stack.Species.Ensemble.Niche.Model()){
  ## Argument checking function ##
  # Occurences, Environment, and part of X, Y, Pcol are directly defined in functions
  ...
  if(!inherits(uncertainity,'logical')){stop('uncertainity parameter should be a logical (True or False).')}
