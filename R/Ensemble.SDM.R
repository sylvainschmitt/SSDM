...
#'@slot algorithm.evaluation data frame. Ensemble SDM evaluation results (including AUC, Kappa, sensitivity, specificity and proportion of
#'  correctly predicted occurrences) and optimal threshold
