...
---
# TO DO (task assigned to...)
- **model forecasting** (SS,LB)
...
- add model calibration statistics (LB)
- document all S4 class and methods
- implement backwards compatibility with source packages (SS,LB)
- add more methods for pseudo-absence generation, e.g. buffer (LB)
