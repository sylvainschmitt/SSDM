...
The interface has three tabs on the left, apperring as the requirements are fullfilled: `Load` to load datasets or models, `Modelling` to specify, train/test and save a model, and `Results` to display the results. 
